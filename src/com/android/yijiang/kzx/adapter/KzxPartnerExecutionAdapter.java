 ...
 * @author tanke
 */
public class KzxPartnerExecutionAdapter extends ArrayAdapter<TaskBean> implements Filterable{
	...
	public KzxPartnerExecutionAdapter(Context context, String typeStr) {
