...
public class KzxCopySelectedAdapter extends BaseAdapter implements Filterable {
	...
	public KzxCopySelectedAdapter(Context context) {
	...
	public void removeDataForOne(String position,LeaderBean leaderBean){
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.kzx_copy_selected_lv_item_fragment, parent, false);
