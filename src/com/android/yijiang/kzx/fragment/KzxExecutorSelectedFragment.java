...
import com.android.yijiang.kzx.adapter.KzxExecutorSelectedAdapter;
 ...
 */
@SuppressLint("NewApi")
public class KzxExecutorSelectedFragment extends BaseFragment {

	private String TAG=KzxExecutorSelectedFragment.class.getName();
	...
	private KzxExecutorSelectedAdapter kzxCopySelectedAdapter;
	
	//头部View
	private ImageButton backBtn;
	private EditText searchEt;
	
	public static KzxExecutorSelectedFragment newInstance(HashMap<String, LeaderBean> isLeaderHash) {
		KzxExecutorSelectedFragment fragment = new KzxExecutorSelectedFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View contentView = inflater.inflate(R.layout.kzx_executor_selected_fragment, null);
		return contentView;
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		kzxCopySelectedAdapter=new KzxExecutorSelectedAdapter(getActivity());
		...
		doneBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(StringUtils.isNullOrEmpty(isSelected)){
					...
					Intent mIntent=new Intent(getActivity().getPackageName()+".INVITE_RECEIVED_ACTION");
		...
		kzxCopySelectedAdapter.setOnItemClickListener(new KzxExecutorSelectedAdapter.OnItemClickListener() {
			@Override
			public void onItemClick(String position, LeaderBean leaderBean, boolean isChecked) {
